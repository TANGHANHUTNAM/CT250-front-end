...
const HeaderNav = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <div className="relative headernav-container flex items-center justify-between py-2 bg-bgPrimary xl:px-[80px] lg:px-[20px] sm:px-[10px]">
        {/* Logo */}
        <div>
          <NavLink
            to="/"
            className="w-[150px] h-[65px] flex items-center justify-between"
          >
        ...
        <div className="flex items-center gap-2">
            ...
            <div className="sm:group-hover:block hidden absolute dropdown-menu right-0 pt-4">
              <div className="flex flex-col gap-3 w-96 p-4 bg-primary rounded-md">
                ...
                <form className="w-full relative">
                  ...
                  <hr />
                  {/* Result search */}
                  <div className="absolute mt-3 p-3 flex flex-col gap-3 w-full bg-zinc-100 rounded-lg">
          ...
          <Link to="/cart/12" className="relative">
            ...
            <p className="absolute flex justify-center items-center rounded-full bg-tertiary text-sm text-primary aspect-square w-[20px] h-[20px] text-[10px] left-3 bottom-4">
              9
            </p>
          </Link>
          <div className="group relative">
            ...
            <div className="group-hover:block hidden absolute dropdown-menu right-0 pt-4 cursor-pointer">
              <div className="flex flex-col gap-3 w-52 p-3 bg-primary rounded-md">
                <p className="bg-tertiary p-1 rounded-md text-center text-sm text-primary hover:bg-yellow-600 duration-500">
                  Đăng nhập
                </p>
                <p className="bg-tertiary p-1 rounded-md text-center text-sm text-primary hover:bg-yellow-600 duration-500">
                  Đăng ký
          ...
          <Link className="hidden booking-table md:flex" to="/booking">
            <button className="bg-tertiary text-primary text-sm rounded-md font-bold hover:bg-yellow-600 duration-500 w-20 h-8">
              Đặt bàn
            </button>
          </Link>
          {/* Menu-icons */}
